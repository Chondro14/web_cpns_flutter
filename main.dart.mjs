...
_1613: x0 => x0.name,
_1614: x0 => x0.options,
_1619: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4,x5,x6,x7,x8,x9),
_1620: (x0,x1) => new firebase_firestore.GeoPoint(x0,x1),
_1622: x0 => globalThis.firebase_firestore.Bytes.fromUint8Array(x0),
_1625: x0 => globalThis.firebase_firestore.Timestamp.fromMillis(x0),
_1633: x0 => ({source: x0}),
_1635: x0 => ({serverTimestamps: x0}),
_1636: (x0,x1) => globalThis.firebase_firestore.getFirestore(x0,x1),
_1645: (x0,x1) => globalThis.firebase_firestore.collection(x0,x1),
_1651: (x0,x1) => globalThis.firebase_firestore.doc(x0,x1),
_1652: () => globalThis.firebase_firestore.documentId(),
_1659: x0 => globalThis.firebase_firestore.getDocs(x0),
_1660: x0 => globalThis.firebase_firestore.getDocsFromCache(x0),
_1661: x0 => globalThis.firebase_firestore.getDocsFromServer(x0),
_1663: x0 => globalThis.firebase_firestore.limit(x0),
_1664: x0 => globalThis.firebase_firestore.limitToLast(x0),
_1669: (x0,x1) => globalThis.firebase_firestore.orderBy(x0,x1),
_1676: (x0,x1) => globalThis.firebase_firestore.query(x0,x1),
_1687: (x0,x1,x2) => globalThis.firebase_firestore.where(x0,x1,x2),
_1688: () => globalThis.firebase_firestore.or,
_1689: () => globalThis.firebase_firestore.and,
_1699: x0 => x0.path,
_1702: () => globalThis.firebase_firestore.GeoPoint,
_1703: x0 => x0.latitude,
_1704: x0 => x0.longitude,
_1706: () => globalThis.firebase_firestore.Bytes,
_1708: x0 => x0.toUint8Array(),
_1710: x0 => x0.type,
_1712: x0 => x0.doc,
_1714: x0 => x0.oldIndex,
_1716: x0 => x0.newIndex,
_1718: () => globalThis.firebase_firestore.DocumentReference,
_1722: x0 => x0.path,
_1733: x0 => x0.metadata,
_1734: x0 => x0.ref,
_1735: (x0,x1) => x0.data(x1),
_1743: x0 => x0.docs,
_1745: x0 => x0.metadata,
_1754: () => globalThis.firebase_firestore.Timestamp,
_1755: x0 => x0.seconds,
_1756: x0 => x0.nanoseconds,
_1793: x0 => x0.hasPendingWrites,
_1795: x0 => x0.fromCache,
_1802: x0 => x0.source,
_1807: () => globalThis.firebase_firestore.startAfter,
_1808: () => globalThis.firebase_firestore.startAt,
_1809: () => globalThis.firebase_firestore.endBefore,
_1810: () => globalThis.firebase_firestore.endAt,
_1831: (x0,x1) => globalThis.firebase_firestore.setDoc(x0,x1),
_1835: x0 => globalThis.firebase_firestore.doc(x0),
_1836: x0 => x0.docChanges(),
_1840: () => globalThis.firebase_firestore.getFirestore(),
_1846: x0 => new firebase_firestore.FieldPath(x0),
_1847: (x0,x1) => new firebase_firestore.FieldPath(x0,x1),
_1848: (x0,x1,x2) => new firebase_firestore.FieldPath(x0,x1,x2),
_1849: (x0,x1,x2,x3) => new firebase_firestore.FieldPath(x0,x1,x2,x3),
_1850: (x0,x1,x2,x3,x4) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4),
_1851: (x0,x1,x2,x3,x4,x5) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4,x5),
_1852: (x0,x1,x2,x3,x4,x5,x6) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4,x5,x6),
_1853: (x0,x1,x2,x3,x4,x5,x6,x7) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4,x5,x6,x7),
_1854: (x0,x1,x2,x3,x4,x5,x6,x7,x8) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4,x5,x6,x7,x8),
_1855: f => finalizeWrapper(f, function() { return dartInstance.exports._1855(f,arguments.length) }),
...
_1864: (x0,x1) => x0.appendChild(x1),
_1865: (x0,x1) => x0.appendChild(x1),
_1866: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1866(f,arguments.length,x0) }),
_1888: (x0,x1) => x0.getItem(x1),
_1889: (x0,x1) => x0.removeItem(x1),
_1890: (x0,x1,x2) => x0.setItem(x1,x2),
_1908: x0 => new Array(x0),
_1911: (o, c) => o instanceof c,
...
_1941: (decoder, codeUnits) => decoder.decode(codeUnits),
_1942: () => new TextDecoder("utf-8", {fatal: true}),
_1943: () => new TextDecoder("utf-8", {fatal: false}),
_1944: v => v.toString(),
_1945: (d, digits) => d.toFixed(digits),
_1949: x0 => new WeakRef(x0),
_1950: x0 => x0.deref(),
_1956: Date.now,
_1958: s => new Date(s * 1000).getTimezoneOffset() * 60 ,
_1959: s => {
...
_1961: () => typeof dartUseDateNowForTicks !== "undefined",
_1962: () => 1000 * performance.now(),
_1963: () => Date.now(),
_1966: () => new WeakMap(),
_1967: (map, o) => map.get(o),
_1968: (map, o, v) => map.set(o, v),
_1969: () => globalThis.WeakRef,
_1980: s => JSON.stringify(s),
_1981: s => printToConsole(s),
_1982: a => a.join(''),
_1983: (o, a, b) => o.replace(a, b),
_1985: (s, t) => s.split(t),
_1986: s => s.toLowerCase(),
_1987: s => s.toUpperCase(),
_1988: s => s.trim(),
_1989: s => s.trimLeft(),
_1990: s => s.trimRight(),
_1992: (s, p, i) => s.indexOf(p, i),
_1993: (s, p, i) => s.lastIndexOf(p, i),
_1994: (s) => s.replace(/\$/g, "$$$$"),
_1995: Object.is,
_1996: s => s.toUpperCase(),
_1997: s => s.toLowerCase(),
_1998: (a, i) => a.push(i),
_2002: a => a.pop(),
_2003: (a, i) => a.splice(i, 1),
_2005: (a, s) => a.join(s),
_2006: (a, s, e) => a.slice(s, e),
_2009: a => a.length,
_2011: (a, i) => a[i],
_2012: (a, i, v) => a[i] = v,
_2013: (a, t) => a.concat(t),
_2014: (o, offsetInBytes, lengthInBytes) => {
      var dst = new ArrayBuffer(lengthInBytes);
      new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
      return new DataView(dst);
    },
_2015: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
_2016: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
...
_2019: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
_2020: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
_2021: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
_2023: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
_2024: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
_2025: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
_2026: (t, s) => t.set(s),
...
_2068: (o, t) => o instanceof t,
_2070: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2070(f,arguments.length,x0) }),
_2071: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2071(f,arguments.length,x0) }),
...
_2078: () => Date.now(),
_2079: () => new XMLHttpRequest(),
_2080: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_2081: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_2082: (x0,x1) => x0.send(x1),
_2084: x0 => x0.getAllResponseHeaders(),
_2092: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2092(f,arguments.length,x0) }),
_2093: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_2094: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
_2112: (x0,x1) => x0.key(x1),
_2113: x0 => x0.trustedTypes,
_2115: (x0,x1) => x0.text = x1,
_2117: (s, m) => {
          try {
...
_2121: (x0,x1) => x0.exec(x1),
_2122: x0 => x0.pop(),
_2126: (x0,x1,x2) => x0[x1] = x2,
_2128: o => o === undefined,
_2129: o => typeof o === 'boolean',
_2130: o => typeof o === 'number',
_2132: o => typeof o === 'string',
_2135: o => o instanceof Int8Array,
_2136: o => o instanceof Uint8Array,
_2137: o => o instanceof Uint8ClampedArray,
_2138: o => o instanceof Int16Array,
_2139: o => o instanceof Uint16Array,
_2140: o => o instanceof Int32Array,
_2141: o => o instanceof Uint32Array,
_2142: o => o instanceof Float32Array,
_2143: o => o instanceof Float64Array,
_2144: o => o instanceof ArrayBuffer,
...
_2156: o => o.length,
_2159: (o, i) => o[i],
_2160: f => f.dartFunction,
_2161: l => arrayFromDartList(Int8Array, l),
_2162: (data, length) => {
...
_2163: l => arrayFromDartList(Uint8ClampedArray, l),
_2164: l => arrayFromDartList(Int16Array, l),
_2165: l => arrayFromDartList(Uint16Array, l),
_2166: l => arrayFromDartList(Int32Array, l),
_2167: l => arrayFromDartList(Uint32Array, l),
_2168: l => arrayFromDartList(Float32Array, l),
_2169: l => arrayFromDartList(Float64Array, l),
_2170: (data, length) => {
...
_2171: l => arrayFromDartList(Array, l),
_2172:       (s, length) => {
        if (length == 0) return '';
...
_2181: (o, p) => o[p],
_2182: (o, p, v) => o[p] = v,
_2183: (o, m, a) => o[m].apply(o, a),
_2185: o => String(o),
_2186: (p, s, f) => p.then(s, f),
_2187: s => {
      if (/[[\]{}()*+?.\\^$|]/.test(s)) {
          s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
      }
...
_2302: (x0,x1) => x0.withCredentials = x1,
_2304: x0 => x0.responseURL,
_2305: x0 => x0.status,
_2306: x0 => x0.statusText,
_2308: (x0,x1) => x0.responseType = x1,
_2309: x0 => x0.response,
_3645: (x0,x1) => x0.type = x1,
_3653: (x0,x1) => x0.crossOrigin = x1,
_3655: (x0,x1) => x0.text = x1,
_4125: () => globalThis.window,
_4450: x0 => x0.trustedTypes,
_4452: x0 => x0.localStorage,
_4797: x0 => x0.length,
_7922: () => globalThis.document,
_8015: x0 => x0.head,
_15073: () => globalThis.console,
_15104: x0 => x0.name,
